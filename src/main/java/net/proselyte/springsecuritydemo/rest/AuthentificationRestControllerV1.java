...
public class AuthentificationRestControllerV1 {
    ...
    public AuthentificationRestControllerV1(AuthenticationManager authenticationManager,
    ...
    @PostMapping("/login")
    public ResponseEntity<?> authentificate(@RequestBody AuthentificationRequestDTO request) {
        try {
